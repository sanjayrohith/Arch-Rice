...
# Sanjay Arch-Hyprland uninstall script #
...
whiptail --title "Arch-Hyprland Sanjay Dots Uninstall Script" --yesno \
"Hello! This script will uninstall Sanjay Hyprland packages and configs.
